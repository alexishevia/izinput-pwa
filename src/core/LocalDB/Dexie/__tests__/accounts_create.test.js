  ...
  const tests = [
    {
      ...
      action: { id: "candy", initialBalance: 0, type: "EXTERNAL" },
      expect: {
        accounts: [{ id: "candy", initialBalance: 0, type: "EXTERNAL" }],
        actionsCount: 1,
        lastAction: { id: "candy", initialBalance: 0, type: "EXTERNAL" },
      },
    },
    {
    ...
    {
      name: "account with invalid type is ignored",
      action: { id: "invalidType", type: "FOO" },
